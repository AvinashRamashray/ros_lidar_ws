...
{
    node.param<std::string>("model",config_.device_name,"R-Fans-16");
    ...
    nh.param<int>("device_port", config_.dataport, 2016);
    nh.param<std::string>("device_ip", config_.device_ip, "192.168.0.82");
    nh.param<int>("rps", config_.scnSpeed, 10);
    nh.param<std::string>("pcap", config_.simu_filepath, "/home/bkth/ws/pcap/R-Fans_32MP_yes.pcap");
